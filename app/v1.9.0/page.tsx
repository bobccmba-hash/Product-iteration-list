...
const prdDocs = [
  ...
  { title: '首页热门菜单', desc: '配置首页品牌展示区域、标题、布局与品牌卡片跳转。', href: '/prd/home-brand', pill: '后台' },
...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: '首页热门菜单', desc: '配置首页品牌展示区域：标题、布局与品牌卡片跳转。', href: '/admin/home-brand' },
...
const iterationData = [
  ...
  { feature: '首页版面调整', href: '/admin/home-brand', description: '首页中间区域增加品牌展示区域，新增首页热门菜单。' },
